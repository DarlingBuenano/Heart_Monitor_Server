...
class Familiares(models.Model):
    ...
    ruta_foto = models.ImageField(upload_to="perfil", null=True, blank=False)
    usuario_paciente = models.ForeignKey(Usuarios, on_delete=models.PROTECT, related_name="Familiares")
    genero = models.CharField(max_length=1)
...
class SaludCardiaca(models.Model):
    usuario = models.ForeignKey(Usuarios, on_delete=models.PROTECT, related_name="SaludCardiaca")
...
class Alertas(models.Model):
    usuario = models.ForeignKey(Usuarios, on_delete=models.PROTECT, related_name="Alertas")
...
class SMS(models.Model):
    usuario = models.ForeignKey(Usuarios, on_delete=models.PROTECT, related_name="SMS")
